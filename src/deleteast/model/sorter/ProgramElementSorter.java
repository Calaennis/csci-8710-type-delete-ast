 ...
 * @(#) ProgElemSorter.java
 */
package deleteast.model.sorter;
 ...
 * @since J2SE-1.8
 */
public class ProgramElementSorter extends ViewerComparator {
   private int propertyIndex;
   private static final int DESCENDING = 1;
   private int direction = DESCENDING;

   public ProgramElementSorter() {
   ...
   public int compare(Viewer viewer, Object e1, Object e2) {
      ...
      case 0:
         rc = p1.getPackageName().compareTo(p2.getPackageName());
         break;
      case 1:
