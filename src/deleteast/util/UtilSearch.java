...
public class UtilSearch {
   /*
    * Searches "searchTerm" in "content" and returns an array of int pairs (index, length) for 
    * each occurrence. The search is case-sensitive. The consecutive occurrences are merged 
    * together.
    * Examples: 
